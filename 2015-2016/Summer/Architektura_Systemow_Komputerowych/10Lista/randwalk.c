//	Usuniecie skokow z sekcji switcha, bardzo nieznacznie poprawilo efektywnosc 4,02 -> 3,41
  ...
  do {
    ...
    if (k < 0) {
      ...
      dir = fast_random();
		...
		int a = (dir >> k) & 3;
		int b = n - 1 ;
		int c[4]= {i > 0, i < b, j > 0, j < b};
		int d[4] = { a == 0, a == 1, a == 2, a == 3};
    ...
    /* Replace switch statement with code that does not use branch
     * instructions. Removed 12 lines here! */
  } while (--len);
